                                                                    ...
                                                                    <div class="card">
                                                                        <div class="card-header">
                                                                            ...
                                                                            @if ($list->offer_type == MyApp::PERCENTAGE)
                                                                                <b>PERCENTAGE</b>
                                                                                {{-- <button class="editOfferBtn float-right"
                                                                                    value="{{ $list->id }}"><i
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div
                                                                                        class="col-md-12 text-center"style="font-size: 22px; color:red ">
                                                                                        @if ($list->offer_type == MyApp::PERCENTAGE)
                                                                                            <b
                                                                                                class="text-center">{{ $list->discount_offer }}%</b>
                                                                                            <b
                                                                                                class="text-center">Discount</b>
                                                                                        @endif
                                                                                        @if ($list->offer_type == MyApp::VALUES)
                                                                                            <b
                                                                                                class="float-left">{{ ucwords($list->summary) }}</b>
                                                                                            <b
                                                                                                class="text-center">{{ $list->discount_offer }}%</b>
                                                                                            <b
                                                                                                class="float-right ">Discount</b>
                                                                                        @endif

                                                                                        @if ($list->offer_type == MyApp::PICES)
                                                                                            <b
                                                                                                class="text-center">{{ ucwords($list->summary) }}</b>
                                                                                        @endif
                                                                        ...
                                                                        @endif
                                                                        <div class="row">
                                                                            <div class="col-md-6"><small><b>From
                                                                                        Date</b></small></b></div>
                                                                            <div class="col-md-6 text-end"><small><b>To
                                                                                        Date</b></small></b></div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
